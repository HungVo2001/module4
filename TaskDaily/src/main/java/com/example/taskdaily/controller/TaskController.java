...
import com.example.taskdaily.service.task.TaskHistoryService;
...
public class TaskController {
    ...
    public ModelAndView showListTasks(@RequestParam(required = false) String message) {
        ...
        view.addObject("tasks", taskService.getTaskHistory());
...
//
    ...
    public ModelAndView homeTask() {
        ...
        List<TaskListResponse> allTasks = taskService.getTaskHistory();
